...
const TopDoctor = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
      ...
      <p className="sm:w-1//3 text-bg-center text-sm">Simply browse through our extensive list of trusted doctors.</p>
      ...
      <button onClick={()=>{navigate('/doctors'); scrollTo(0,0)}} className="bg-blue-50 tetx-gray-600 px-12 py-3 rounded-full mt-10">more</button>
    </div>
  );
};
